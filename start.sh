...
#Xray版本
AUUID="cceda3db-f73b-469b-bb2e-0bc6215fdf18"
CADDYIndexPage="https://www.free-css.com/assets/files/free-css-templates/download/page264/the-card.zip"
PORT=8080
...
XRAY_URL="https://github.com/XTLS/Xray-core/releases/download/v1.5.6/Xray-linux-64.zip"
wget -N ${XRAY_URL}
